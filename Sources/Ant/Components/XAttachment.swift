...
public class XAttachment: Component {
    ...
    public convenience init(rfc5545 value: String) throws {
        ...
        guard icalcomponent_isa(rawValue).hub.wrap() == .XATTACH else {
    ...
    public convenience init() {
        self.init(icalcomponent_new(Wrap<icalcomponent_kind>.XATTACH.rawValue))
    }
