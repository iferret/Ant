...
class XDaylight: Component {
    ...
    public convenience init(rfc5545 value: String) throws {
        ...
        guard icalcomponent_isa(rawValue).hub.wrap() == .XDAYLIGHT else {
    ...
    public convenience init() {
        self.init(icalcomponent_new(Wrap<icalcomponent_kind>.XDAYLIGHT.rawValue))
    }
